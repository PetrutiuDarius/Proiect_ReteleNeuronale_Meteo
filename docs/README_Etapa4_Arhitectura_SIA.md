...
![Diagrama State Machine](state-machine-RN.png)
...
1.  **Pagina "România Live":**
    ...
    * ![Dashboard Live](screenshots/dashboard_romania_1.png)
    * ![Dashboard Live](screenshots/dashboard_romania_2.png)
    * ![Dashboard Live](screenshots/dashboard_romania_3.png)
...
2.  **Pagina "Simulator manual":**
    ...
    * ![Simulator Input](screenshots/dashboard_simulation.png)
...
3.  **Pagina "Monitor ESP32":**
    ...
    * ![ESP32 Monitor](screenshots/dashboard_liveESP_etapa_5.png)
