...
![Prediction Plot V2](prediction_plot_all_versions/prediction_plot_9_input_parameters_V2.png)
...
![Prediction Plot V4](prediction_plot_all_versions/prediction_plot_asymmetric_loss_V4.png)
...
![Prediction Plot V5](prediction_plot_all_versions/prediction_plot_log_transform_V5.png)
...
![MAE Comparison](optimization/mae-comparison.png)
...
![R2 Comparison](optimization/r2_comparison.png)
...
![Learning Curve Final](results/learning_curves_final.png)
...
![Dashboard Live ESP 1](screenshots/dashboard_liveESP_1.png)
*Fig 4.2.1. Secțiunea de administrare a modelului adaptiv și statusul conexiunii Azure.*

![Dashboard Live ESP 2](screenshots/dashboard_liveESP_2.png)
...
![Diagrama de stări completă a sistemului (Versiunea 2)](state-machine-RN_V2.png)
...
![Diagrama de stări inițială (Versiunea 1 - Etapa 4)](state-machine-RN.png)
